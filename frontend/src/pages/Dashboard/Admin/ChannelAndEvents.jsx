    ...
    <div className="space-y-12">
      ...
      {events && (
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* event cards */}
          {events.map(event => (
          <div key={event._id} className="bg-[var(--secondary)] p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[var(--text)]/20">
            {/* Card Header */}
            <div className="bg-blue-600 px-4 py-2 flex justify-between items-center">
              <span className="text-white font-medium">Tennis Match</span>
              <button
                className="text-white hover:text-red-200 transition-colors"
                onClick={() => confirm("Delete this event?") && handleDelete()}
                title="Delete event"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-gray-200 mb-2 overflow-hidden border-2 border-blue-500">
                    <img
                  ...
                  <span className="font-medium text-center">Team A</span>
                </div>

                <span className="text-xl font-bold mx-4">vs</span>

                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-gray-200 mb-2 overflow-hidden border-2 border-red-500">
                    <img
                      src="https://via.placeholder.com/150"
                      alt="Team B"
                      className="w-full h-full object-cover"
                  ...
                  <span className="font-medium text-center">Team B</span>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText("Enter match stream url");
                      alert("URL copied!");
                    }}
                  >
                    <svg
